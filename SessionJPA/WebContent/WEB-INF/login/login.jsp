...
<head>
   ...
   <link href="https://fonts.googleapis.com/css?family=Ubuntu:400,500,700" rel="stylesheet">
	...
	<!-- waves css -->
	<link rel="stylesheet" type="text/css" href="public/assets/plugins/Waves/waves.min.css">
	...
	<!--color css-->
	<link rel="stylesheet" type="text/css" href="public/assets/css/color/color-1.min.css" id="color"/>
		...
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="login-card card-block">
					<form class="md-float-material" action="User" method="get">
						<div class="text-center">
							<img src="public/assets/images/logo-black.png" alt="logo">
						</div>
...
<!-- waves effects.js -->
<script src="public/assets/plugins/Waves/waves.min.js"></script>
<!-- Custom js -->
